<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        <a class="sidebar-brand brand-logo" href="redirect"><img src="https://logodix.com/logo/1692302.png"
                alt="logo" /></a>
        <a class="sidebar-brand brand-logo-mini" href="redirect"><img src="https://logodix.com/logo/1692302.png"
                alt="logo" /></a>
    </div>
    <ul class="nav">
            ...
            <div class="profile-desc">
                <div class="profile-pic">
                    ...
                    <div class="profile-name">
                        <h5 class="mb-0 font-weight-normal">Prashanth Bandari</h5>
                        <span>Admin</span>
                    </div>
                </div>
