    ...
    <header class="">
        ...
        @if (session()->has('message'))
            <div class="alert alert-success">
                <button type="submit" class="close" style="float: right padding:10px;" data-dismiss="alert"
        ...
        <table>
            ...
            @foreach ($cart as $carts)
                <tr style="background-color: black;">
                    ...
                    <td style="padding: 10px; color:white">  <input type="text" name="price[]" value=" {{ $carts->price }}" hidden="">
                      {{ $carts->price }}</td>
